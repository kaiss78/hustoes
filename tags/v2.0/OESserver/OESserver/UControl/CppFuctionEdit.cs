...
{
    public partial class CppFuctionEdit : UserControl
    {
        ProMan aProMan;
        public bool isnew = false;
        public CppFuctionEdit(ProMan pm)
        {
            InitializeComponent();
            aProMan = pm;
        }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            if (!isnew)
            {
                InfoControl.OesData.UpdateFunProgram(ProList.click_proid, procon.Text, propath.Text, in1.Text, in2.Text, in3.Text, out1.Text, out2.Text, out3.Text, anspath.Text, "0");
            }
            else
            {
                InfoControl.OesData.AddFunProgram(procon.Text, propath.Text, in1.Text, in2.Text, in3.Text, out1.Text, out2.Text, out3.Text, anspath.Text, "0");
            }
