...
namespace OES.UPanel
{
    public partial class PaperEditPanel : UserPanel
    {
        ...
        {
            this.Visible = true;
            btnChoice.Visible = InfoControl.TmpPaper.ProList[0].Capacity > 0;            
            btnCompletion.Visible = InfoControl.TmpPaper.ProList[1].Capacity > 0;
            btnJudge.Visible = InfoControl.TmpPaper.ProList[2].Capacity > 0;
